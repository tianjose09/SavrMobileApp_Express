    ...
    return (
      <View key={req.id}>
        ...
        <View style={styles.reportTable}>
          ...
          {renderSummaryRow('Date Needed', req.drive_start_date ? new Date(req.drive_start_date).toLocaleDateString('en-PH') : null)}
          {renderSummaryRow('End Date', req.drive_end_date ? new Date(req.drive_end_date).toLocaleDateString('en-PH') : null)}
